  ...
  const questionSets = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['London', 'Seoul', 'New York', 'Tokyo'],
        ...
        },
        {
          ...
          options: ['Shy', 'Serious', 'Outgoing', 'Lazy'],
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['By subway', 'By bike', 'By bus', 'On foot'],
        ...
        },
        {
          ...
          options: ['Relaxed', 'Very busy', 'Inconsistent', 'Unplanned'],
