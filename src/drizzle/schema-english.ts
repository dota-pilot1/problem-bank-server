...
// 5. English User Attempts (영어 풀이 기록)
export const englishUserAttempts = pgTable('english_user_attempts', {
  id: serial('id').primaryKey(),
  userId: integer('user_id').notNull(),
  testSetId: integer('test_set_id').references(() => englishTestSets.id),
  problemId: integer('problem_id')
    .references(() => englishProblems.id)
    .notNull(),
